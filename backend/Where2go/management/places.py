        ...
        for item in data.get('result', {}).get('items', []):
            ...
            if rating >= min_rating:
                ...
                results.append({
                    ...
                    'distance': distance,
                    '2gis_link': generate_2gis_link(place_lat, place_lon, item['name']),
                    'direction_links': {
                        'google': generate_direction_link('google', place_lat, place_lon),
                        'yandex': generate_direction_link('yandex', place_lat, place_lon)
                    }
                })
